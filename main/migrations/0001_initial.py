    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie_duration', models.CharField(default='2:00', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='MovieSession',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.cinemaroom')),
                ('session_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.moviesession')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('combo_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.foodandbeverage')),
