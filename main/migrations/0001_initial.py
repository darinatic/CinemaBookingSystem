# Generated by Django 4.2 on 2023-05-17 08:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room_name', models.CharField(default='Room 1', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=datetime.datetime(2023, 5, 17, 16, 0, 42, 608968))),
                ('movie_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.movie')),
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.cinemaroom')),
            ],
        ),
        migrations.CreateModel(
            name='Seat',
            fields=[
                ...
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.cinemaroom')),
                ('session_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.moviesession')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('ticket_type', models.CharField(default='Adult', max_length=20)),
                ('cost', models.FloatField(null=True)),
                ('purchased_date', models.DateTimeField(default=datetime.datetime(2023, 5, 17, 16, 0, 42, 624667))),
                ('is_paid', models.BooleanField(default=False)),
                ('combo_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.foodanddrinks')),
                ('movie_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.moviesession')),
